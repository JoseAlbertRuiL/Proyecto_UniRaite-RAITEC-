...
-- AddForeignKey
ALTER TABLE "viajes_publicados" ADD CONSTRAINT "viajes_publicados_id_conductor_fkey" FOREIGN KEY ("id_conductor") REFERENCES "usuarios"("id_usuario") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "viajes_publicados" ADD CONSTRAINT "viajes_publicados_id_vehiculo_fkey" FOREIGN KEY ("id_vehiculo") REFERENCES "vehiculos"("id_vehiculo") ON DELETE RESTRICT ON UPDATE CASCADE;
